...
public class Generatectivity extends AppCompatActivity {
    ...
    private void createChineseQRCode() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode("王浩", BGAQRCodeUtil.dp2px(Generatectivity.this, 150));
            }
    ...
    private void createEnglishQRCode() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode("bingoogolapple", BGAQRCodeUtil.dp2px(Generatectivity.this, 150), Color.parseColor("#ff0000"));
            }
    ...
    private void createChineseQRCodeWithLogo() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(Generatectivity.this.getResources(), R.mipmap.logo);
                return QRCodeEncoder.syncEncodeQRCode("王浩", BGAQRCodeUtil.dp2px(Generatectivity.this, 150), Color.parseColor("#ff0000"), logoBitmap);
            }
    ...
    private void createEnglishQRCodeWithLogo() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(Generatectivity.this.getResources(), R.mipmap.logo);
                return QRCodeEncoder.syncEncodeQRCode("bingoogolapple", BGAQRCodeUtil.dp2px(Generatectivity.this, 150), Color.BLACK, Color.WHITE, logoBitmap);
            }
